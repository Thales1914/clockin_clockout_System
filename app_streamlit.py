...
# --- Envolvemos toda a aplicação num bloco try...except para apanhar qualquer erro inesperado ---
try:
    ...
    def carregar_registros():
        ...
        # Se o ficheiro não existir, cria um ficheiro vazio para evitar erros
...
# Este bloco 'except' irá apanhar QUALQUER erro que aconteça na execução e mostrá-lo no ecrã
except Exception as e:
    st.error("Ocorreu um erro inesperado na aplicação.")
    st.exception(e) # st.exception mostra os detalhes técnicos do erro no ecrã